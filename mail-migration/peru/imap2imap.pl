...
my $general_log        = "migracion.log";
my $get_email_log      = "error-extraer-direccion.log";
my $invalid_email_log  = "error-direccion-novalida.log";
my $invalid_domain_log = "error-dominio.log";
my $bbdd_log           = "bbdd.log";
