...
my $stderr_log         = "errores-ur.log";
my $general_log        = "migracion-ur.log";
my $bbdd_log           = "bbdd-ur.log";
...
my $start_migration_date = "20070118"; # Los mensajes posteriores a este se almacenaran
                                       # como no leidos
